...
export const LatestNews = () => {
    ...
    return (
      ...
      <div className="flex flex-wrap -mx-4">
          {/* Main News Item */}
          <Link href={`/news/${firstNews.title}`} className="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
          ...
          <div className="w-full lg:w-1/2 px-4">
              {otherNews.slice(0, 3).map((news, index) => (
                  <Link key={index} href={`/news/${news.title}`} className="flex mb-4 bg-white p-4 rounded-lg shadow-lg">
